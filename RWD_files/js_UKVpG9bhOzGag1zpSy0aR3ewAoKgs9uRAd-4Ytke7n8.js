...
(function ( document, window ) {
    ...
    var impress = window.impress = function ( rootId ) {
        ...
        var next = function () {
            ...
            if (jQuery('.content li:hidden, .content .show:hidden', activeStep).length) {
                jQuery('.content li:hidden, .content .show:hidden', activeStep).first().fadeIn();
                return false;
            }
            else {
                return goto(next);
    ...
    init : function(config) {
      ...
      if ($(document).width() < options.deviceWidth){
        $(this).each(function() {
          ...
          $('a', _o).each(function() {
            var el = $(this),
            sl = el.parent('li').hasClass('active') ? 'selected' : false;
            $("<option />", {
              "selected": sl,
              "value": el.attr("href"),
              "text": el.text()
